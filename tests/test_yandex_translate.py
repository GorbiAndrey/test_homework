...
class TestSecretaryProgram(unittest.TestCase):
    ...
    def test_translate_valid_data(self):
        res = yandex_translate.translate(self.valid_data['text_untranslate'], self.valid_data['lang'])
        self.assertEqual(res[1], "Привет, Мир")
        self.assertEqual(res[0], 200)

    def test_translate_invalid_data(self):
        res = yandex_translate.translate(self.invalid_data['text_untranslate'], self.invalid_data['lang'])
